...
public class SupervisorTests extends JUnitSuite {
    ...
    private static final FiniteDuration WAIT_PERIOD = new FiniteDuration(10, TimeUnit.SECONDS);
    ...
    public void testSupervisorInitialization() {
        new TestKit(system) {{
            ...
            for (int id = 1;id < workersNum;id++) {
                ...
                getSystem().actorSelection(workerPath).
            ...
            assertEquals(String.format("Worker with id %d has wrong configuration", workersNum), received.message, Messages.PrintHops);
        }};
    }
}
